...
/**
 * Basic Message class for the USBAccessoryManager. This is used to send
 * messages from the USB Accessory's read thread to the GUI thread to notify the
 * GUI thread of various USB Accessory events (like data available or device
 * attachment).
 * 
...
public class USBAccessoryManagerMessage {
	...
	public enum MessageType {
		READ, ERROR, CONNECTED, DISCONNECTED, READY
	};
	 ...
	 *            The data associated with this message
	 * @param accessory
	 *            The accessory associated with this message
	 */
	public USBAccessoryManagerMessage(MessageType type, byte[] data,
